package com.heroes.lesh.kidneys.FragmentsFoodRules;
 ...
 */
public class FoodRulesFragment extends Fragment {
    //Variables globales
    private ListenerPag callback;
    @BindView(R.id.card_view_food_rules_foods_card)
    CardView card_view_food_rules_foods_card;
    @BindView(R.id.card_view_food_rules_recipes_card)
    CardView card_view_food_rules_recipes_card;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_food_rules, container, false);
        unbinder = ButterKnife.bind(this, view);
        inicializar();
        changeColors();
        //evento del boton
        card_view_food_rules_recipes_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendFragment(3);
            }
        });
        card_view_food_rules_foods_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendFragment(4);
            }
    ...
    private void setColorsApp(int color) {
        card_view_food_rules_foods_card.setCardBackgroundColor(color);
        card_view_food_rules_recipes_card.setCardBackgroundColor(color);
    }
