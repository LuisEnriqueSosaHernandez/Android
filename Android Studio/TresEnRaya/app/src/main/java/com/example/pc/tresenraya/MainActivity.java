package com.example.pc.tresenraya;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Iniciamos el array casilla que indentifica cada casilla y la almacena en en array
        CASILLAS=new int[9];
        CASILLAS[0]=R.id.a1;
        CASILLAS[1]=R.id.a2;
        CASILLAS[2]=R.id.a3;
    ...
    private void termina(int resultado){
        String mensaje;
        if (resultado==1||resultado==2)mensaje="Ha ganado el jugador "+resultado;
        //else if(resultado==2)mensaje="Ha ganado el jugador "+resultado;
        else mensaje="Empate perros";
